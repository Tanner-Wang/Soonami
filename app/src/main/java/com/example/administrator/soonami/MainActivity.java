package com.example.administrator.soonami;
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                //》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》》
                //检查响应代码是否等于200（HTTP响应成功），如果是之后就可以从inputStream获取jsonResponse
                if(urlConnection.getResponseCode()==200) {
                    inputStream = urlConnection.getInputStream();
                    jsonResponse = readFromStream(inputStream);
                }
                else{
                    Log.e(LOG_TAG,"The responseCode is "+urlConnection.getResponseCode());
                }
            } catch (IOException e) {
                Log.e(LOG_TAG,"There is an error in makeHTTPConnection method",e);
            } finally {
